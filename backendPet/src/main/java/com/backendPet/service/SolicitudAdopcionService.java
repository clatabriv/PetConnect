...
public class SolicitudAdopcionService {
    ...
    public boolean existeSolicitudPendiente(Long adoptanteId, Long animalId) {
        return solicitudRepository.existsByAdoptanteIdAndAnimalIdAndEstadoSolicitud(
            adoptanteId, animalId, SolicitudAdopcion.EstadoSolicitud.PENDIENTE);
    }
    ...
    public SolicitudAdopcion create(Long adoptanteId, Long animalId, 
        ...
        // Verificar que no exista ya una solicitud PENDIENTE del mismo adoptante para el mismo animal
        boolean yaExisteSolicitud = solicitudRepository.existsByAdoptanteIdAndAnimalIdAndEstadoSolicitud(
            adoptanteId, animalId, SolicitudAdopcion.EstadoSolicitud.PENDIENTE);
        
        if (yaExisteSolicitud) {
            throw new ResponseStatusException(
                HttpStatus.CONFLICT, "Ya tienes una solicitud pendiente para este animal");
        }
